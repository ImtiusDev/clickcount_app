...
class SecondScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    print('Second Screen head context : ${context.hashCode}');
    return Scaffold(
      appBar: AppBar(
        ...
        children: [
              ...
              return Container(
                ...
                child: Center(
                  child: BlocBuilder<CounterCubit, CounterState>(
                    builder: (context, state) {
                      print('Second Screen BlocBuilder state context : ${context.hashCode}');
                      return Text(
                        '${state.counterValue}',
                        style: TextStyle(
                          fontSize: 60,
            ...
            children: [
              ElevatedButton(
                ...
                onPressed: () {
                  ...
                  print(
                    'Second screen Decrement Btn context: ${context.hashCode}',
                  );
                },
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  ...
                  print(
                    'Second screen Increment Btn context: ${context.hashCode}',
                  );
                },
          ...
          TextButton(
            onPressed:(){
                  ...
                  print('Second Screen Reset Btn context: ${context.hashCode}');
              },
